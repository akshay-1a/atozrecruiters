            ...
            <div className="container mx-auto px-16 py-16">
                <div className="grid grid-cols-2 justify-end">
                    ...
                    <div className="space-y-5 py-7 overflow-visible">
                        <Clip start="right" className="absolute">
                            <h1
                                className="capitalize z-10 w-2/3 text-3xl md:text-6xl lg:text-6xl font-extrabold text-slate-700 hover:text-slate-800 transition-colors duration-300 drop-shadow overflow-visible pb-3"
                            >
                                {context.headline}
                            </h1>
                        </Clip>
                        ...
                        <Clip start="right">
                            <p className="text-slate-600 font-medium tracking-wider text-xl pt-40 pb-10 px-2">
                                {context.para}
                            </p>
                        </Clip>
                        <Clip start="right">
