...
export function HeroSection({ data }: HeroProps) {
  return (
    <section className={`relative w-full md:h-[89vh] p-4 md:p-10 pt-24 flex items-start justify-end overflow-hidden bg-gradient-to-r from-cyan-950 to-cyan-700 text-white`}>
