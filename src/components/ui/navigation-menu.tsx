...
>(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Trigger
    ref={ref}
    className={cn(navigationMenuTriggerStyle(), "group hover:opacity-100", className)}
    {...props}
  >
    {children}{""}
    <ChevronDown
...
>(({ className, ...props }, ref) => (
  <div className={cn("absolute right-0 top-full flex justify-center z-50")}>
